...
//
Функция ПолучитьРезультатПроверкиПодключенияПоХТТП(АдресПодключения, ИдентификаторОбмена) Экспорт
	
	ТекстСообщения = "";
	
	УРЛ = АдресПодключения + ?(СтрЗаканчиваетсяНа(АдресПодключения, "/"), "", "/") + "hs/smp_exchange/ping/" + ИдентификаторОбмена;
