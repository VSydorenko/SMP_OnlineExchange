...
Функция ПодключитьОбработку(ИмяОбработки) Экспорт
	...
	Если Файл.Существует() и СМП_ОнлайнОбменОбщегоНазначения.РежимОтладки() Тогда
...
Функция ПриЗаписиОбъектаВыполнитьОбработку(Источник) Экспорт
	...
	Если СМП_ОнлайнОбменОбщегоНазначения.РежимОтладки() Тогда
		СМП_СобытияОтправкиДанных.ОтправитьДанные(Параметры);
	Иначе
		МассивПараметров = Новый Массив;
		МассивПараметров.Добавить(Параметры);
		ФоновыеЗадания.Выполнить("СМП_СобытияОтправкиДанных.ОтправитьДанные", МассивПараметров, "", "Подключаемый обработчик");
	КонецЕсли;
