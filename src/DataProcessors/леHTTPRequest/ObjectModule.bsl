...
Функция ОтправитьДанные1сНаУдаленыйСервер(Данные, Адрес, Параметры = Неопределено) Экспорт
	...
	ДополнительныеПараметры = Новый Структура("Логин,Пароль");
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "POST", Адрес, Данные, Неопределено, ДополнительныеПараметры);
...
Функция Get(URL, ПараметрыЗапроса = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "GET", URL, Неопределено, ПараметрыЗапроса, ДополнительныеПараметры);
...
Функция Options(URL, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "OPTIONS", URL, Неопределено, Неопределено, ДополнительныеПараметры);
...
Функция Head(URL, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "HEAD", URL, Неопределено, Неопределено, ДополнительныеПараметры);
...
Функция Post(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "POST", URL, Данные, Неопределено, ДополнительныеПараметры);
...
Функция Put(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "PUT", URL, Данные, Неопределено, ДополнительныеПараметры);
...
Функция Patch(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "PATCH", URL, Данные, Неопределено, ДополнительныеПараметры);
...
Функция Delete(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, "DELETE", URL, Данные, Неопределено, ДополнительныеПараметры);
...
Функция ВызватьМетод(Метод, URL, ДополнительныеПараметры = Неопределено) Экспорт 
	...
	Возврат ВызватьHTTPМетод(
		Неопределено, Метод, URL, Неопределено, Неопределено, ДополнительныеПараметры);
...
Функция КакJson(Ответ, ПараметрыПреобразованияJSON = Неопределено) Экспорт
	...
	Возврат Конвертер.ПрочитатьJSON_Стандартная(Ответ);
...
Функция ВызватьМетодВСеансе(Сессия, Метод, URL, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат ВызватьHTTPМетод(Сессия, Метод, URL, Неопределено, Неопределено, ДополнительныеПараметры);	
...
Функция ВызватьHTTPМетод(Сессия, Метод, URL, Данные, ПараметрыЗапроса, ДополнительныеПараметры)
	Возврат Устарела_ВызватьHTTPМетод(Сессия, Метод, URL, Данные, ПараметрыЗапроса, ДополнительныеПараметры)
КонецФункции

Функция Устарела_ВызватьHTTPМетод(Сессия, Метод, URL, Данные, ПараметрыЗапроса, ДополнительныеПараметры)
...
Процедура ПодготовитьТелоЗапроса(ПодготовленныйЗапрос, Данные, Файлы)
