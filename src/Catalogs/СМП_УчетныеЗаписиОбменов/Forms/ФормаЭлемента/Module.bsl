...
Процедура СписокПКСПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ИначеЕсли Группа Тогда
		Отказ = Истина;
		мПараметрыФормы = Новый Структура("ЗначенияЗаполнения", 
		Новый Структура("Владелец, ОбъектИсточник, ОбъектПриемник, УчетнаяЗаписьОбменаДанными", 
		ТекущееПКО, ТекДанныеСписокПКО.Источник, ТекДанныеСписокПКО.Приемник, Объект.Ссылка
		));
		ОткрытьФорму("Справочник.ПравилаКонвертацииСвойств.Форма.ФормаГруппы", мПараметрыФормы, ЭтотОбъект);
	Иначе
		Отказ = Истина;
		мПараметрыФормы = Новый Структура("ЗначенияЗаполнения", 
		Новый Структура("Владелец, ОбъектИсточник, ОбъектПриемник, УчетнаяЗаписьОбменаДанными", 
		...
		ОткрытьФорму("Справочник.ПравилаКонвертацииСвойств.Форма.ФормаЭлемента", мПараметрыФормы, ЭтотОбъект);
	КонецЕсли;
...
Процедура СписокПКЗПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Иначе
		Отказ = Истина;
		мПараметрыФормы = Новый Структура("ЗначенияЗаполнения", 
		Новый Структура("Владелец, ОбъектИсточник, ОбъектПриемник", ТекущееПКО, ТекДанныеСписокПКО.Источник, ТекДанныеСписокПКО.Приемник));
		ОткрытьФорму("Справочник.ПравилаКонвертацииЗначений.Форма.ФормаЭлемента", мПараметрыФормы, Элемент);
	КонецЕсли;
