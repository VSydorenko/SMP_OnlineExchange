...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ЗаписьПравилаКонвертации" Тогда
		...
		Объект.ОписаниеПравилКонвертации = ПолучитьОписаниеПравил(Объект.Ссылка);
...
//
&НаСервереБезКонтекста
Функция ПолучитьОписаниеПравил(УчетнаяЗаписьОбмена) 
	
	ОписаниеПравил = Справочники.СМП_УчетныеЗаписиОбменов.СформироватьОписаниеПравилКонвертации(УчетнаяЗаписьОбмена); 
	Возврат ОписаниеПравил;
	
КонецФункции // ПолучитьОписаниеПравил
